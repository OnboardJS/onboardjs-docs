...
export function Hero() {
  return (
    <div className="dark:pt-19 overflow-hidden bg-slate-900 dark:-mb-32 dark:mt-[-4.75rem] dark:pb-32">
        ...
        <div className="lg:max-w-8xl mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="font-display bg-linear-to-r inline from-sky-700 via-sky-400 to-sky-700 bg-clip-text text-5xl tracking-tight text-transparent">
                Stop Reinventing the Onboarding Wheel. Start Building.
              </p>
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Your users need smooth flows. You need clean code, faster.
                OnboardJS handles the messy state stuff so that you can focus on
                building.
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="/#h1">Get started</Button>
                <Button
