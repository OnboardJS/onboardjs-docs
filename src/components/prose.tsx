  ...
  return (
    <Component
      className={clsx(
        ...
        // pre
        'prose-pre:rounded-xl prose-pre:shadow-lg dark:prose-pre:bg-slate-800/60 dark:prose-pre:shadow-none dark:prose-pre:ring-1 dark:prose-pre:ring-slate-300/10',
        // hr
